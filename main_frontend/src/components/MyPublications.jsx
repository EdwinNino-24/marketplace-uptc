...
export const MyPublications = ({ user, href_user_profile,
    ...
    useEffect(() => {
        ...
        if (token) {
            Axios.post('http://localhost:5050/get_my_posts', { token })
                .then(response => {
    ...
    useEffect(() => {
        setLoading(true);
        fetch('http://localhost:5050/get_states')
    ...
    const handleOptionChange = (id, event) => {
        ...
        Axios.post('http://localhost:5050/update_publication_state', {
            publicationId: id,
            newState: newState,
    ...
    const handleDeletePost = (id) => {
        setLoading(true);
        Axios.post('http://localhost:5050/delete_post', {
            publicationId: id,
            token: localStorage.getItem('token')
        })
            .then(response => {
                        ...
                        <div className="my-publication" key={publication.ID_PUBLICATION}>
                            <div className="my_publication">
                                ...
                                <div className="properties_my_publication">
                                    ...
                                    <button className="chats-my-publication" onClick={() => handleMyChats(publication.ID_PUBLICATION)}>Chats</button>
